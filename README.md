...
- Add **GLM-5.3-Flash** (`zai/glm-5.3-flash`) — the first **natively multimodal** model in the GLM-5 series (320B total / 18B activated). Sources: [docs.z.ai/guides/vlm/glm-5.3-flash](https://docs.z.ai/guides/vlm/glm-5.3-flash) + [pricing](https://docs.z.ai/guides/overview/pricing), snapshot 2026-08-26.
  ...
  - No `bigmodel/` mirror added — the bigmodel docs and pricing pages could not be read to confirm the SKU is offered on the domestic gateway, and inventing an entry there is worse than omitting one. Add it once availability is confirmed
...
- Exported total **142 → 143** (+1); no existing entries changed.
